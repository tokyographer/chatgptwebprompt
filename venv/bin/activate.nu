...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/tokyographer1/Sites/Python/chatgptwebprompt/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/tokyographer1/Sites/Python/chatgptwebprompt/venv/bin/deactivate.nu'
